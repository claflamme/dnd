...
backgroundsList = [require('./backgrounds/acolyte'), require('./backgrounds/charlatan'), require('./backgrounds/criminal'), require('./backgrounds/entertainer'), require('./backgrounds/folk-hero')];
...
},{"./backgrounds/acolyte":2,"./backgrounds/charlatan":3,"./backgrounds/criminal":4,"./backgrounds/entertainer":5,"./backgrounds/folk-hero":6}],2:[function(require,module,exports){
module.exports = {
  name: "Acolyte",
