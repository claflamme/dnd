...
backgroundsList = [require('./backgrounds/acolyte'), require('./backgrounds/charlatan')];
...
BackgroundGenerator = (function(superClass) {
  ...
  BackgroundGenerator.prototype.render = function() {
    ...
    }, el('h3', null, 'Background'), el('p', null, background.name), el('h3', null, 'Flaw'), el('p', null), flaw.text, el('h3', null, 'Bond'), el('p', null), bond.text, el('h3', null, 'Ideal'), el('p', null), el('strong', null, ideal.summary + ": "), ideal.text, el('h3', null, 'Personality Trait'), el('p', null), personality.text)));
  };
...
},{"./backgrounds/acolyte":2,"./backgrounds/charlatan":3}],2:[function(require,module,exports){
module.exports = {
  name: "Acolyte",
  quip: "priest",
  flaws: [
